...
- The inspector lists draft-proxy status for every Timeline v2 video (primary and B-roll) with a per-asset bar. Monitor actions show `ready/total`. Final render still uses originals.
