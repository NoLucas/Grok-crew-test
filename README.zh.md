...
**Grok Crew 是装在你电脑上的短视频工作台。你只写规格，Grok 机器人送来素材和剪辑。**

不必把原片放在这台电脑。写好时长、字幕、要留下的句子即可。**另一台电脑**上的机器人会做好视频和剪辑再交过来。这台电脑负责接收。只有你愿意时才发到 Instagram、TikTok 或 YouTube。

它不是托管素材的网站。机器人打不开这台电脑，只推送一个包裹。

```
你的规格  →  机器人准备原片并剪辑  →  这台电脑接收  →  你说可以才发布
```

## 给谁用

- 只想规定 Reel 长什么样、不想在这台机器上找原片的人
- 想让另一台电脑上的 Grok 负责找素材和初剪的人
...
首屏请你**写规格**。保存后复制文字，交给另一台电脑上的 Grok。机器人推送包裹后，点**接收机器人剪辑**。**查看示例如何送达**会用内置片段演示同一次到达。
